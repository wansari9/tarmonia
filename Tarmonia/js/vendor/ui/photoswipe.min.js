    ...
    return function(e, t, n, i) {
        var o = {
            ...
            addClass: function(e, t) {
                if(o && e) o.hasClass(e, t) || (e.className += (e.className ? " " : "") + t)
            },
            hasClass: function(e, t) {
				var e_x;
				if(e) e_x = e.className;
                return  e_x && new RegExp("(^|\\s)" + t + "(\\s|$)").test(e.className)
            },
        ...
        var l, s, u, c, d, p, m, f, h, y, x, v, g, w, b, I, C, D, M, T, S, A, E, O, k, R, Z, P, F, L, _, z, N, U, H, Y, B, W, G, X, V, K, q, $, j, J, Q, ee, te, ne, ie, oe, ae, re, le, se, ue = {
            ...
            et = {
                ...
                init: function() {
                    if (!l && !s) {
                        var n;
						var e_x, a_x, c_x, cc_x, ccc_x;
						if (e)e_x = e.className;
						if (a.container) {
							a_x = a.container.style;
							c_x = a.container.children[0];
							cc_x = a.container.children[1];
							ccc_x = a.container.children[2];
						}
                        a.framework = o, a.template = e, a.bg = o.getChildByClass(e, "pswp__bg"), Z = e_x, l = !0, _ = o.detectFeatures(), k = _.raf, R = _.caf, A = _.transform, F = _.oldIE, a.scrollWrap = o.getChildByClass(e, "pswp__scroll-wrap"), a.container = o.getChildByClass(a.scrollWrap, "pswp__container"), d = a_x, a.itemHolders = I = [{
                            el: c_x,
                            wrap: 0,
                            index: -1
                        }, {
						...
						var e_x, s_x, p_x;
						if(e) e_x = e.setAttribute("aria-hidden", "false");
						if(e) s_x = e.style.position;
						if(e) p_x = e.style.top;
                        ...
                        t && (a.ui = new t(a, o)).init(), Me("firstUpdate"), c = c || r.index || 0, (isNaN(c) || c < 0 || c >= Kt()) && (c = 0), a.currItem = Vt(c), (_.isOldIOSPhone || _.isOldAndroid) && (xe = !1), e_x, r.modal && (xe ? s_x = "fixed" : (s_x = "absolute", p_x = o.getScrollY() + "px")), L === undefined && (Me("initialLayout"), L = P = o.getScrollY());
                        var u = "pswp--open ";
                ...
                updateSize: function(t) {
					...
					var a_x;
					if(a.scrollWrap) a_x = a.scrollWrap.clientWidth;
					var h_x;
					if(a.scrollWrap) h_x = a.scrollWrap.clientHeight;
                    if (pe.x = a_x, pe.y = h_x, Ve(), he.x = pe.x + Math.round(pe.x * r.spacing), he.y = pe.y, Re(he.x * me), Me("beforeResize"), p !== undefined) {
