  ...
  function renderProducts(list){
    ...
    list.forEach(function(p){
      ...
      li.innerHTML = ''+
        ...
        + '        <img src="'+(p.image||(window.AppPaths && typeof window.AppPaths.join === 'function' ? window.AppPaths.join('images/placeholder.png') : 'images/placeholder.png'))+'" class="attachment-shop_catalog size-shop_catalog" alt="" />\n'
        + '      </a>\n'
        + '    </div>\n'
        + '  </div>\n'
