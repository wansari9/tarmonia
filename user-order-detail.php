...
<head>
    <title>Order Details &#8211; Tarmonia</title>
    <meta charset="UTF-8" />
                    ...
                    <div class="content_wrap">
                        <div class="columns_wrap columns_fluid">
                            <div class="column-4_5 contact_logo">
                                <div class="logo">
                                    <a href="index.html">
                                        <img src="images/tarmonia-new-tag.png" class="logo_main" alt="" width="239" height="59">
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="post_content entry-content">
                            ...
                            <div class="profile-container">
                                <div class="breadcrumb" style="margin-bottom:20px;">
                                    ...
                                    <a href="user-profile.php#orders">Orders</a> / 
                                    <span>Order <span data-order-id>#0</span></span>
                                </div>
                                ...
                                <div class="profile-card">
                                    ...
                                    <div class="order-detail-grid" style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:20px;margin-bottom:30px;">
                                        <div>
                                            <div style="font-size:13px;color:#999;margin-bottom:4px;">Order Number</div>
                                            <div style="font-size:16px;font-weight:600;" data-order-num>#0</div>
                                        </div>
                                        <div>
                                            <div style="font-size:13px;color:#999;margin-bottom:4px;">Order Date</div>
                                            <div style="font-size:16px;font-weight:600;" data-order-date>-</div>
                                        </div>
                                        <div>
                                        ...
                                        <div data-tracking-section style="display:none;">
                                            ...
                                            <div style="font-size:16px;font-weight:600;" data-tracking-num>-</div>
                                        </div>
                                    </div>
                                    ...
                                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:30px;margin-top:40px;">
                                        <div>
                                            <h3 style="margin:0 0 16px;font-size:18px;border-bottom:2px solid #f0f0f0;padding-bottom:12px;">Shipping Address</h3>
                                            <div data-shipping-address style="font-size:15px;line-height:1.8;color:#666;"></div>
                                        </div>
                                        <div>
                                            <h3 style="margin:0 0 16px;font-size:18px;border-bottom:2px solid #f0f0f0;padding-bottom:12px;">Billing Address</h3>
                                            <div data-billing-address style="font-size:15px;line-height:1.8;color:#666;"></div>
                                        </div>
                                    </div>
